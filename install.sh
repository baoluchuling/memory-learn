...
echo "    /organize           Health report"
echo "    /rebuild            Repair index"
echo "    /config             Settings (auto_learn on/off, etc.)"
echo ""
echo "  Auto-learn is ON by default (records without asking)"
echo "  To disable: bash $CLAUDE_SKILL_DIR/scripts/config.sh set auto_learn off"
echo ""
echo "  Built-in auto memory remains enabled (works alongside memory-learn)"
